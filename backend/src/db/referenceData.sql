...
INSERT INTO permissions (name, description, group_name) VALUES
  ...
  ('vibes.reply',          'Comment on or reply to vibes',                       'vibes'),
...
SELECT seed_role_permissions('platform_admin',
  ...
  'vibes.reply','vibes.read','vibes.delete.any','vibes.pin','vibes.feature',
...
SELECT seed_role_permissions('content_moderator',
  'users.read',
  'vibes.reply','vibes.read','vibes.delete.any','vibes.pin',
...
SELECT seed_role_permissions('verified_educator',
  ...
  'vibes.create','vibes.reply','vibes.read','vibes.update.own','vibes.delete.own',
